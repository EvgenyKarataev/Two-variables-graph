...
namespace TwoVariablesGraph
{
    ...
    public class OpenGLControl : System.Windows.Forms.UserControl
    {
        ...
        public const UInt32 GLF_START_LIST = 1000;
    ...
    //    public static extern bool wglUseFontOutlines(IntPtr hdc, uint first, uint count, uint listBase, float deviation, float extrusion, int format, IntPtr hz);
        ...
        [DllImport("opengl32.dll")] public static extern unsafe byte * glGetString(uint name);
        ...
        protected virtual void CreateOpenGLContext()
        {
            try 
            {
               ...
               // wglUseFontOutlines(_hDC, 0, 256, GLF_START_LIST, 0.0f, 0.15f, WGL_FONT_POLYGONS, IntPtr.Zero);
        ...
        protected void ActivateContext()
        {
          ...
          //  if (wglGetCurrentContext() == IntPtr.Zero && wglGetCurrentDC() == IntPtr.Zero)
           //     throw new Exception("The OpenGL context is already activated.");WGL_FONT_POLYGONS
        ...
        protected void DeactivateContext()
        {
         ...
         //   if (wglGetCurrentContext() != IntPtr.Zero && wglGetCurrentDC() != IntPtr.Zero)
          //      throw new Exception("The OpenGL context is already deactivated.");
            wglMakeCurrent(IntPtr.Zero, IntPtr.Zero);
        }
